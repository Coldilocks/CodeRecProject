...
public class ConstructFineTrainData extends ConstructData {
        ...
        for (int i = 0; i < graphList.size(); i++) {
            try {
                ...
                if(graphRepresent != null) {
                    ...
                    FileUtil.saveStringInFile(graphRepresent.getKey(), FileWriterUtil.graphSentenceWriter);// 记录图表示
                    FileUtil.saveStringInFile(graphRepresent.getValue(), FileWriterUtil.vocabWriter);// 记录词汇表
                    ...
                    FileUtil.saveStringInFile((tempGraph.getLines(tempGraph.getRoot(),new ArrayList<>()) + 1) + "", FileWriterUtil.linesWriter);
     ...
     * */
    public void construct(Graph completeGraph, int serialNumber, int holeNumber){
...
//                if(isShowGraph) {
//                    try {
//                        GraphWriteUtil.show(graph.getRoot(), "/Users/wangxin/Workspace/04-DataSpace/CodeRecommendation/GraphTrainWithHoleNodeConstruct/graph/graph_" + count);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                }
