...
//import graph_newest.GraphNewest;
...
//import graph_newest.Predict;
//import org.graalvm.compiler.graph.Graph;
//import predict.LoadSource;
...
//
///**
// * Created by chenchi on 2018/10/8.
// */
...
//        GraphNewest codeGraph =  getCodeGraph(parsedCode).get(0);
//        if (codeGraph == null) {
...
//    }
//
//    public List<String> filter(List<String> softmaxs, GraphNewest graph) {
...
//
//
//    public static void filterNoClass(String api, String str, List<String> list, GraphNewest graph) {
//        NameExtractor ne = new NameExtractor();
//        ne.init();
